...
def cek_hasil():
    print garis
    print k + ' 1. ' + p + '꧁☠ℜ𝔦𝔞𝔷☠️꧂ OK'
    print k + ' 2. ' + p + '꧁☠ℜ𝔦𝔞𝔷☠️꧂ CP'
    print k + ' 3. ' + p + '꧁☠ℜ𝔦𝔞𝔷☠️꧂ CP/OK'
    print garis
    pil = raw_input(h + '>>> ')
    if pil == '1':
        oke = []
        try:
            print h + ' >_<' + p + ' ꧁☠ℜ𝔦𝔞𝔷☠️꧂ OK' + h + '>>>'
            ok = open('꧁☠ℜ𝔦𝔞𝔷☠️꧂_ok.txt', 'r').readlines()
            print ''
            with open('꧁☠ℜ𝔦𝔞𝔷☠️꧂_ok.txt', 'w') as (okeh):
                okeh.write('')
            for dev in set(ok):
                print '   ' + h + dev.replace('\n', '')
                with open('꧁☠ℜ𝔦𝔞𝔷☠️꧂_ok.txt', 'a') as (okeh):
                    okeh.write(dev)
                oke.append(dev)
            ...
            print m + '\n   X ' + p + 'Blom ada ꧁☠ℜ𝔦𝔞𝔷☠️꧂ OK'

        print ''
    elif pil == '2':
        cpe = []
        try:
            print k + ' >_<' + p + ' ꧁☠ℜ𝔦𝔞𝔷☠️꧂ CP' + k + '>>>'
            cp = open('꧁☠ℜ𝔦𝔞𝔷☠️꧂_cp.txt', 'r').readlines()
            print p + '\n   Tgl Crack '
            for dev in cp:
                print '   ' + k + dev.replace('\n', '').replace('==>', ' ')
                cpe.append(dev)
            ...
            print m + '\n   X ' + p + 'Blom ada ꧁☠ℜ𝔦𝔞𝔷☠️꧂ CP'

    elif pil == '3':
        print garis
        print k + ' 1. ' + m + 'Hapus ' + p + '꧁☠ℜ𝔦𝔞𝔷☠️꧂ OK'
        print k + ' 2. ' + m + 'Hapus ' + p + '꧁☠ℜ𝔦𝔞𝔷☠️꧂ CP'
        print garis
        pilih_ku = raw_input(h + '>>> ')
        if pilih_ku == '1':
            y_n = raw_input(a + '\n Yakin mau Hapus ꧁☠ℜ𝔦𝔞𝔷☠️꧂ OK ? ' + p + '[y/n]: ')
            if y_n == 'y':
                try:
                    os.system('del ꧁☠ℜ𝔦𝔞𝔷☠️꧂_ok.txt' if os.name == 'nt' else 'rm -f ꧁☠ℜ𝔦𝔞𝔷☠️꧂_ok.txt')
                    print '\n Sukses.....'
                except:
                    print '\n Belum ada ꧁☠ℜ𝔦𝔞𝔷☠️꧂ OK'

        elif pilih_ku == '2':
            y_n = raw_input(a + '\n Yakin mau Hapus ꧁☠ℜ𝔦𝔞𝔷☠️꧂ CP ? ' + p + '[y/n]: ')
            if y_n == 'y':
                try:
                    os.system('del ꧁☠ℜ𝔦𝔞𝔷☠️꧂_cp.txt' if os.name == 'nt' else 'rm -f ꧁☠ℜ𝔦𝔞𝔷☠️꧂_cp.txt')
                    print '\n Sukses.....'
                except:
                    print '\n Belum ada ꧁☠ℜ𝔦𝔞𝔷☠️꧂ CP'
...
def banner():
    print "꧁☠ℜ𝔦𝔞𝔷☠️꧂+ p + + k + '\n PREMIUM' + p + ' {' + h + '꧁☠ℜ𝔦𝔞𝔷☠️꧂' + p + '}' + a + ' \\/ {' + k + 'Author' + a + ': ' + h + '꧁☠ℜ𝔦𝔞𝔷☠️꧂' + a + '} '
    print h + ' >>>' + p + ' IP: ' + k + ip
